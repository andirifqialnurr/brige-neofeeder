...
class NeoFeederReferenceSyncServiceTest extends TestCase
{
    ...
    public function test_it_normalizes_get_jalur_masuk_response(): void
    {
        ...
        $this->assertSame([
            [
                'endpoint' => 'GetJalurMasuk',
                'value_key' => 'id_jalur_masuk',
                'value' => '12',
    ...
    public function test_it_normalizes_get_jenis_evaluasi_response(): void
    {
        ...
        $this->assertSame([
            [
                'endpoint' => 'GetJenisEvaluasi',
                'value_key' => 'id_jenis_evaluasi',
                'value' => '1',
    ...
    public function test_it_normalizes_get_list_penugasan_dosen_response(): void
    {
        ...
        $this->assertSame([
            [
                'endpoint' => 'GetListPenugasanDosen',
                'value_key' => 'id_registrasi_dosen',
                'value' => 'reg-dosen-1',
                'label' => 'Dosen Contoh',
                'raw_payload' => [
                    'id_registrasi_dosen' => 'reg-dosen-1',
    ...
    public function test_it_normalizes_get_list_kelas_kuliah_response(): void
    {
        ...
        $this->assertSame([
            [
                'endpoint' => 'GetListKelasKuliah',
                'value_key' => 'id_kelas_kuliah',
                'value' => 'kelas-1',
                'label' => 'Algoritma',
                'raw_payload' => [
                    'id_kelas_kuliah' => 'kelas-1',
